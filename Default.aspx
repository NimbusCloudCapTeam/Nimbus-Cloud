        ...
        <div class="row">
            <div class="container-fluid" >
                <div class="col-md-2"  style="background-color:#1D2731; min-height: 690px">
                   ...
                   <div style="min-height:20px"></div>
                  <div class="container" id="accountList">
            ...
            <div class="col-md-8"  style="background-color:white; min-height: 690px;">
                <table class="table" >
                  ...
                  <tbody>
                    <tr>
                      <th scope="row"><input type="radio" name ="fileselect" /></th>
                      <td>File</td>
                      <td>3/3/2012</td>
                      <td>JPEG</td>
                      <td>120KB</td>
...
<script>
    $('#accountMenu a').click(function (e) {
        ...
        if (this.id == "boxPan") {
           // $('#boxAccount').empty();
            $('#boxAccount').html("<li><input type=\"radio\" name=\"boxAccountRadio\"/>Super Account</li><li><input type=\"radio\" name=\"boxAccountRadio\"/> Child Account1</li><li><input type=\"radio\" name=\"boxAccountRadio\"/> Child Account2</li>");
            var accounts;
            /*$.ajax({
                type: "POST",
                url: "Default.aspx/getAccounts",
                ...
                success: function (responce) {
                    ...
                    var accList = accounts.toString().split(',');
                    $.each(accList, function (index, item) {
                        $('#boxAccount').append("<li><input type=\"radio\" name=\"boxaccountCheck\" /> " + item + "</li>");
                    });
                },
        ...
        if (this.id == "dropboxPan") {
            $('#boxAccount').empty();
            $('#dropboxAccount').html("<li><input type=\"radio\" name=\"dropboxAccountRadio\"/>Super Account</li><li><input type=\"radio\" name=\"dropboxAccountRadio\"/> Child Account1</li><li><input type=\"radio\" name=\"dropboxAccountRadio\"/> Child Account2</li>");
            $('#googleAccount').empty();
            $('#onedriveAccount').empty();
        }
        if (this.id == "googlePan") {
            $('#boxAccount').empty();
            $('#dropboxAccount').empty();
            $('#googleAccount').html(" <li><input type=\"radio\" name=\"googleAccountRadio\"/>Super Account</li><li><input type=\"radio\" name=\"googleAccountRadio\"/> Child Account1</li><li><input type=\"radio\" name=\"googleAccountRadio\"/> Child Account2</li>");
            $('#onedriveAccount').empty();
        }
        if (this.id == "onedrivePan") {
           ...
           $('#dropboxAccount').empty();
           $('#googleAccount').empty();
           $('#onedriveAccount').html(" <li><input type=\"radio\" name=\"onedriveAccountRadio\"/>Super Account</li><li><input type=\"radio\" name=\"onedriveAccountRadio\"/> Child Account1</li><li><input type=\"radio\" name=\"onedriveAccountRadio\"/> Child Account2</li>");
        }
